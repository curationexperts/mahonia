...
class CatalogController < ApplicationController
  ...
  include Mahonia::BlacklightHelper
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("description", :stored_searchable), itemprop: 'description', helper_method: :render_truncated_description
